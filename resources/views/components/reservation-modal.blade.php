    ...
    <form id="reservation-form" action="">
        ...
        <div style="overflow:auto;">
            <div style="float:right;" class="mt-3">
                <button type="button" id="prevBtn" class="btn btn-red" onclick="nextPrev(-1)">Trước</button>
                <button type="button" id="nextBtn" class="btn btn-green" onclick="nextPrev(1)">Kế tiếp</button>
            </div>
        </div>
